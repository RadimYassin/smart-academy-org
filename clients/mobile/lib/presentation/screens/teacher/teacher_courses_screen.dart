...
import 'modals/create_course_modal.dart';

class TeacherCoursesScreen extends GetView<CoursesController> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => controller.showCreateCourseModal.value = true,
      ...
      body: Stack(
        children: [
          ...
          // Modals overlay
          Obx(() => controller.showCreateCourseModal.value
    ...
    return Card(
      ...
      child: InkWell(
        onTap: () {
          ...
          Get.toNamed('/teacher/courses/${course.id}');
        },
        borderRadius: BorderRadius.circular(12),
        child: Column(
                        ...
                        Row(
                          children: [
                            IconButton(
                              ...
                              onPressed: () => controller.openEditCourseModal(course),
                              padding: EdgeInsets.zero,
                              constraints: const BoxConstraints(),
                            ),
                            IconButton(
                              icon: const Icon(Icons.delete, size: 18, color: Colors.red),
                              onPressed: () => controller.openDeleteCourseModal(course),
                              padding: EdgeInsets.zero,
                              constraints: const BoxConstraints(),
                            ),
                          ],
